...
final dataMap = <String, double>{
  ...
  Languages.elementAt(20): php.reversed.first,
  Languages.elementAt(21): powerShell.reversed.first,
  Languages.elementAt(22): python.reversed.first,
  Languages.elementAt(23): r.reversed.first,
  Languages.elementAt(24): ruby.reversed.first,
  Languages.elementAt(25): rust.reversed.first,
  Languages.elementAt(26): scala.reversed.first,
  Languages.elementAt(27): shell.reversed.first,
  Languages.elementAt(28): sql.reversed.first,
  Languages.elementAt(29): swift.reversed.first,
  Languages.elementAt(30): tex.reversed.first,
  Languages.elementAt(31): text.reversed.first,
  Languages.elementAt(32): toml.reversed.first,
  Languages.elementAt(33): typeScript.reversed.first,
  Languages.elementAt(34): yaml.reversed.first,
};
