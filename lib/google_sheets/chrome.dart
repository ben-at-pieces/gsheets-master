...
class ChromeAlertDialog extends StatefulWidget {
  @override
  _CustomVSCodeAlertDialogState createState() => _CustomVSCodeAlertDialogState();
}

class _CustomVSCodeAlertDialogState extends State<ChromeAlertDialog> {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              contentPadding: EdgeInsets.only(top: 10.0, left: 20.0, right: 20.0, bottom: 10.0),
              title: Row(
                children: [
                  Image.asset(
                    'chrome.jpeg', // Replace this with your own image asset
                    width: 40.0,
                    height: 40.0,
                  ),
                  SizedBox(width: 10.0),
              ...
              actions: <Widget>[
                TextButton(
                  ...
                  onPressed: () async {
                    ...
                    final ws = await ssheet.worksheetByTitle('Chrome');
