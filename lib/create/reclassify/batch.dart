...
//
// Future<void> batchReclassify() async {
...
//   AssetReclassification assetReclassify =
//       AssetReclassification(ext: ClassificationSpecificEnum.bat, asset: first);
//
//   String? original = assetReclassify.asset.original.reference?.classification.specific.value;
//   print(original);
// }
